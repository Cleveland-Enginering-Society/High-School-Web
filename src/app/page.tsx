...
export default function Home() {
      ...
      {/* FULL-WIDTH STRIPE */}
        <section className="w-full bg-[#00539eff] py-12">
          <div className="max-w-5xl mx-auto px-12 text-center">
            <h2 className="text-white text-4xl md:text-5xl font-bold font-kanit">
              LEARN. CONNECT. LEAD.
            </h2>
          <p className="text-white/90 text-sm md:text-base mt-7 font-kanit">
  ...
  <div className="mt-8 text-right">
    ...
    <section className="w-full bg-[#f59e0b] py-20">
      {/* TEXT CONTENT */}
      <div className="max-w-5xl mx-auto px-6 text-left">
        <h2 className="font-kanit text-white text-3xl font-bold mb-2 w-full">
          OUR MISSION
        </h2>
        <p className="font-kanit text-white text-2xl translate-y-10 w-full">
