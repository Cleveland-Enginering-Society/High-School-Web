...
import StudentChapterOfficers from '@/components/about/StudentChapterOfficers';
    ...
    <>
      <section className="w-full bg-white py-2">
        <div className="max-w-5xl mx-auto px-5">
          <div className="text-[#00539eff] text-4xl font-bold">
            <p className="mb-4">WHO WE ARE</p>
          </div>
        </div>
      </section>

      <section className="w-full bg-white py-2 pb-8">
        <div className="max-w-5xl mx-auto px-5">
